...
<template>
  <div v-if="organization">
    <div class="org">
      <div v-if="organization.admins.includes(currentUsername)">
        <h3 v-if="!isEditingName">
          {{ orgName }}
          <button class="icon" @click="isEditingName = true" v-b-tooltip.hover title="Edit Organization Name">
        ...
        <div v-else>
          ...
          <button class="icon" @click="updateOrgName" v-b-tooltip.hover title="Update Name">
      ...
      <h4>Admins</h4>
      <div class="row">
        <article v-for="admin in organization.admins" :key="admin" style="background-color: #fde4cf">{{ admin }}</article>
      </div>
      <h4>Members</h4>
      <div class="row">
        <article v-for="member in organization.members" :key="member" style="background-color: #fbf8cc">{{ member }}</article>
      </div>
    </div>
    <div v-if="organization.admins.includes(currentUsername)">
      <div class="modify">
        <button class="icon" @click.prevent="showAddModal = true" v-b-tooltip.hover title="Add Member">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fa9243" class="bi bi-person-fill-add" viewBox="0 0 16 16">
            <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m.5-5v1h1a.5.5 0 0 1 0 1h-1v1a.5.5 0 0 1-1 0v-1h-1a.5.5 0 0 1 0-1h1v-1a.5.5 0 0 1 1 0m-2-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
            <path d="M2 13c0 1 1 1 1 1h5.256A4.493 4.493 0 0 1 8 12.5a4.49 4.49 0 0 1 1.544-3.393C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4" />
          </svg>
        </button>
        <button class="icon" @click.prevent="showManageModal = true" v-b-tooltip.hover title="Manage Organization">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fa9243" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
            <path
        ...
        <button class="icon" @click.prevent="showDeleteModal = true" v-b-tooltip.hover title="Delete Organization">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fa9243" class="bi bi-trash-fill" viewBox="0 0 16 16">
            <path
              d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5M8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5m3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0"
            />
          </svg>
        </button>
        <button v-if="organization.admins.length > 1" class="icon" @click.prevent="showLeaveModal = true" v-b-tooltip.hover title="Leave Organization">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fa9243" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
            <path
              fill-rule="evenodd"
    ...
    <div v-else>
      <div class="modify">
        <button class="icon" @click.prevent="showLeaveModal = true" v-b-tooltip.hover title="Leave Organization">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fa9243" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
            <path
              fill-rule="evenodd"
              d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0z"
