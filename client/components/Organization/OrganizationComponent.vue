...
<template>
  <div v-if="organization">
    <div class="org">
      ...
      <h4>Admins</h4>
      <div class="row">
        <article v-for="admin in organization.admins" :key="admin" style="background-color: #a5e6e4da">{{ admin }}</article>
      </div>
      <h4>Members</h4>
      <div class="row">
        <article v-for="member in organization.members" :key="member" style="background-color: #badda8ea">{{ member }}</article>
      </div>
    </div>
    <div v-if="organization.admins.includes(currentUsername)">
      <div class="modify">
